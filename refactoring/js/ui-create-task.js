...
let sortTaskBtn = document.querySelector('.btn-sort-task');
    ...
    let rererender = () => f.forEach( item => item.remove());
...
switch (taskSortArgument) {
    ...
    case 2:
        ...
        break;
    case 3:
        newTaskList.sortById();
        console.log(taskSortArgument+' - sortById');
        console.log(newTaskList.sortById());
        console.log(newTaskList);
        break;
    case 4:
        newTaskList.sortByDeadLine();
        console.log(taskSortArgument+' - sortByDeadLine');
        console.log(newTaskList.sortByDeadLine());
        console.log(newTaskList);;
        break;
    case 5:
        ...
        break;
    case 6:
        newTaskList.sortByCreateDate();
        console.log(taskSortArgument+' - sortByCreateDate');
        console.log(newTaskList.sortByTitle());
        console.log(newTaskList);
        break;
    case 7:
        newTaskList.sortByOwned();
        console.log(taskSortArgument+' - sortByOwned');
        console.log(newTaskList.sortByOwned());
        console.log(newTaskList);
        break;
    default:
